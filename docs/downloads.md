...
当前版本为 **0.3.7**：[直接下载 ZIP](https://github.com/kkray983681062-bit/RuinsLootHelper/releases/download/v0.3.7/RuinsLootHelper-0.3.7-Windows-x64.zip)。文件大小与 SHA-256 见同版本的 [SHA256SUMS.txt](https://github.com/kkray983681062-bit/RuinsLootHelper/releases/download/v0.3.7/SHA256SUMS.txt)。详情见[验证与限制](validation.md)。
